...
# Remove surface area and cells 

master <- master %>%
  dplyr::select(-c(Surface_Area_cm2, Cells))
...
TP_Coral_Box <- ggplot(master, aes(x=Day, y=Coral_Protein_mgcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        ...
        legend.position="none")  + ggtitle("Coral Total Protein")

TP_Coral_Box
ggsave(filename="output/Physiology/TP_Coral_Box.png", plot=TP_Coral_Box, dpi=300, width=12, height=7, units="in")
...
anova(TP_Coral_lmer, type="III")

capture.output(anova(TP_Coral_lmer, type="III"), file = "output/Statistics/TP_Coral_lmer.csv")
...
TP_Sym_SA_Box <- ggplot(master, aes(x=Day, y=Symbiont_Protein_mgcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Symbiont Total Protein (per cm2)")
TP_Sym_SA_Box

ggsave(filename="output/Physiology/TP_Sym_SA_Box.png", plot=TP_Sym_SA_Box, dpi=300, width=12, height=7, units="in")
...
anova(TP_Sym_lmer, type="III")

capture.output(anova(TP_Sym_lmer, type="III"), file = "output/Statistics/TP_Sym_lmer.csv")
...
TP_Sym_Cell_Box <- ggplot(master, aes(x=Day, y=Protein.mgcell, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Symbiont Total Protein (per cell)")
TP_Sym_Cell_Box

ggsave(filename="output/Physiology/TP_Sym_Cell_Box.png", plot=TP_Sym_Cell_Box, dpi=300, width=12, height=7, units="in")


TP_Sym_cell_lmer <- lmer(Protein.mgcell~Group*Day+(1|Fragment.ID), data = master)
# qqnorm(resid(TP_Sym_cell_lmer))
# qqline(resid(TP_Sym_cell_lmer))
# 
# boxplot(resid(TP_Sym_cell_lmer)~master$Group)
# boxplot(resid(TP_Sym_cell_lmer)~master$Day)
anova(TP_Sym_cell_lmer, type="III")

capture.output(anova(TP_Sym_cell_lmer, type="III"), file = "output/Statistics/TP_Sym_cell_lmer.csv")
...
ggsave(filename="output/Physiology/TP_CS_Box.png", plot=TP_CS_Box, dpi=300, width=12, height=7, units="in")
...
anova(TP_CS_lmer, type="III")

capture.output(anova(TP_CS_lmer, type="III"), file = "output/Statistics/TP_CS_lmer.csv")
...
Sym_Box <- ggplot(master, aes(x=Day, y=Cells.cm2.x6, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")+ ggtitle("Endosymbiont Cell Density (x10^6)")
Sym_Box

ggsave(filename="output/Physiology/Sym_Box.png", plot=Sym_Box, dpi=300, width=12, height=7, units="in")
...
sym_aov<- anova(Sym_lmer, type="III")

capture.output(anova(Sym_lmer, type="III"), file = "output/Statistics/Sym_lmer.csv")
...
Chla_SA_Box <- ggplot(master, aes(x=Day, y=ChlA.ugcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Chlorophyll a (per cm2)")
Chla_SA_Box

ggsave(filename="output/Physiology/Chla_SA_Box.png", plot=Chla_SA_Box, dpi=300, width=12, height=7, units="in")
...
anova(Chla_SA_lmer, type="III")

capture.output(anova(Chla_SA_lmer, type="III"), file = "output/Statistics/Chla_SA_lmer.csv")
...
ggsave(filename="output/Physiology/ChlC2_SA_Box.png", plot=ChlC2_SA_Box, dpi=300, width=12, height=7, units="in")
...
anova(ChlC2_SA_lmer, type="III")

capture.output(anova(ChlC2_SA_lmer, type="III"), file = "output/Statistics/ChlC2_SA_lmer.csv")
...
Chla_cell_Box <- ggplot(master, aes(x=Day, y=ChlA.ugcell, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Chlorophyll a (per cell)")
Chla_cell_Box

ggsave(filename="output/Physiology/Chla_cell_Box.png", plot=Chla_cell_Box, dpi=300, width=12, height=7, units="in")
...
anova(Chla_cell_lmer, type="III")

capture.output(anova(Chla_cell_lmer, type="III"), file = "output/Statistics/Chla_cell_lmer.csv")
...
ggsave(filename="output/Physiology/ChlC2_cell_Box.png", plot=ChlC2_cell_Box, dpi=300, width=12, height=7, units="in")
...
anova(ChlC2_cell_lmer, type="III")

capture.output(anova(ChlC2_cell_lmer, type="III"), file = "output/Statistics/ChlC2_cell_lmer.csv")
...
Carb_Coral_Box <- ggplot(master, aes(x=Day, y=Coral_Carb_mgcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Coral Total Carbohydrate (per cm2)")
Carb_Coral_Box

ggsave(filename="output/Physiology/Carb_Coral_Box.png", plot=Carb_Coral_Box, dpi=300, width=12, height=7, units="in")
...
anova(Carb_Coral_lmer, type="III")

capture.output(anova(Carb_Coral_lmer, type="III"), file = "output/Statistics/Carb_Coral_lmer.csv")
...
Carb_Sym_SA_Box <- ggplot(master, aes(x=Day, y=Symbiont_Carb_mgcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")   + ggtitle("Symbiont Total Carbohydrate (per cm2)")
Carb_Sym_SA_Box

ggsave(filename="output/Physiology/Carb_Sym_SA_Box.png", plot=Carb_Sym_SA_Box, dpi=300, width=12, height=7, units="in")
...
anova(Carb_Sym_SA_lmer, type="III")

capture.output(anova(Carb_Sym_SA_lmer, type="III"), file = "output/Statistics/Carb_Sym_SA_lmer.csv")
...
Carb_Sym_Cell_Box <- ggplot(master, aes(x=Day, y=Carb.mgcell, fill = Group)) +
  ...
  scale_color_manual(values=c("#CC3300", "#46008B", "#468B00")) + 
  scale_x_discrete(labels=c("0" = "Day 0", "37" = "Day 37", "52" = "Day 52")) +
  xlab("Timepoint") +  ylab(expression("Total Carbohydrate " (mg~cell^{-1}))) + #Axis titles
  theme_bw() + theme(panel.border = element_rect(color="black", fill=NA, size=0.75), panel.grid.major = element_blank(), #Makes background theme white
                     panel.grid.minor = element_blank(), axis.line = element_blank()) +
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Symbiont Total Carbohydrate (per cell)")
Carb_Sym_Cell_Box

ggsave(filename="output/Physiology/Carb_Sym_Cell_Box.png", plot=Carb_Sym_Cell_Box, dpi=300, width=12, height=7, units="in")
...
anova(Carb_Sym_Cell_lmer, type="III")

capture.output(anova(Carb_Sym_Cell_lmer, type="III"), file = "output/Statistics/Carb_Sym_Cell_lmer.csv")
...
ggsave(filename="output/Physiology/Carb_CS_Box.png", plot=Carb_CS_Box, dpi=300, width=12, height=7, units="in")
...
anova(Carb_CS_lmer, type="III")

capture.output(anova(Carb_CS_lmer, type="III"), file = "output/Statistics/Carb_CS_lmer.csv")
...
#  ylim(0,0.5) +
  ...
  xlab("Timepoint") +  ylab(expression("Oxygen Flux " (mu*mol ~ cm^{-2} ~ h^{-1}))) + #label y axis + #Axis titles
  theme_bw() + theme(panel.border = element_rect(color="black", fill=NA, size=0.75), panel.grid.major = element_blank(), #Makes background theme white
                     panel.grid.minor = element_blank(), axis.line = element_blank()) +
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position=c(0.90,0.80)) + ggtitle("Gross Photosynthetic Rate")
PG_Box

ggsave(filename="output/Physiology/PG_Box.png", plot=PG_Box, dpi=300, width=12, height=7, units="in")
...
anova(PG_lmer, type="III")

capture.output(anova(PG_lmer, type="III"), file = "output/Statistics/PG_lmer.csv")
...
Resp_Box <- ggplot(master, aes(x=Day, y=abs.Rdark_umol.cm2.hr, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none") + ggtitle("Light-Enhanced Respiration Rate")
Resp_Box

ggsave(filename="output/Physiology/Resp_Box.png", plot=Resp_Box, dpi=300, width=12, height=7, units="in")
...
anova(Resp_lmer, type="III")

capture.output(anova(Resp_lmer, type="III"), file = "output/Statistics/Resp_lmer.csv")
...
PR_Box <- ggplot(master, aes(x=Day, y=PR, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 15, color = "black"),
        axis.title = element_text(size = 18, color = "black"), 
        legend.position="none")  + ggtitle("Photosyntheis to Respiration Ratio")
PR_Box

ggsave(filename="output/Physiology/PR_Box.png", plot=PR_Box, dpi=300, width=12, height=7, units="in")
...
anova(PR_lmer, type="III")

capture.output(anova(PR_lmer, type="III"), file = "output/Statistics/PR_lmer.csv")
...
PHYS_FIG <- ggarrange(PG_Box, Resp_Box, PR_Box, Sym_Box, Chla_SA_Box, Chla_cell_Box, TP_Coral_Box, TP_Sym_SA_Box, TP_Sym_Cell_Box, Carb_Coral_Box, Carb_Sym_SA_Box, Carb_Sym_Cell_Box, 
          labels = c("A)", "B)", "C)", "D)", "E)", "F)", "G)", "H)", "I)", "J)", "K)", "L)"), 
#          size = 10,
          ncol = 3, nrow = 4, align = "v")

ggsave(filename="output/Physiology/Phys_all_fig.png", plot=PHYS_FIG, dpi=300, width=20, height=25, units="in")
```
...
scaled_pca <-prcomp(master.pca[c(4:18)], scale=TRUE, center=TRUE)
fviz_eig(scaled_pca)
...
corr <- ggpairs(master.pca, title="correlogram with ggpairs()") 
ggsave(filename="../output/Physiology/corr_phys.pdf", plot=corr, dpi=300, width=20, height=20, units="in")


```
## PCA Significant loadings

```{r PCAsig, echo=TRUE, warning=FALSE, message=FALSE}

# master.sig <- master %>%
#   dplyr::select(-c(HostSymRatioCarb, Symbiont_Carb_mgcm2, Symbiont_Protein_mgcm2, ChlA.ugcell, ChlC2.ugcell, Protein.mgcell, Pnet_umol.cm2.hr))

master.sig <- master %>%
  dplyr::select(-c(HostSymRatioCarb, HostSymRatioProtein, ChlC2.ugcm2, ChlC2.ugcell, Pnet_umol.cm2.hr))

master.sig_clean <- master.sig %>%
  dplyr::rename(Gross_Photo = Pgross_umol.cm2.hr, 
                LEDR = abs.Rdark_umol.cm2.hr,
                Cell_density = Cells.cm2.x6,
                Chl_a_cm2 = ChlA.ugcm2,
                Chl_a_cell = ChlA.ugcell,
                Coral_Protein = Coral_Protein_mgcm2,
                Sym_Protein_cm2 = Symbiont_Protein_mgcm2,
                Sym_Protein_cell = Protein.mgcell,
                Coral_Carb = Coral_Carb_mgcm2,
                Sym_Carb_cm2 = Symbiont_Carb_mgcm2,
                Sym_carb_cell = Carb.mgcell)

master.sig.pca <- master.sig_clean

scaled_pca.sig <-prcomp(master.sig.pca[c(4:15)], scale=TRUE, center=TRUE)
fviz_eig(scaled_pca.sig)

coral_info<-master.sig.pca[c(2,3)]

pca_data_sig<- scaled_pca.sig%>%
  augment(coral_info)%>%
  group_by(Day, Group)%>%
  mutate(PC1.mean = mean(.fittedPC1),
         PC2.mean = mean(.fittedPC2))

pca.centroids_sig<- pca_data_sig%>% 
  dplyr::select(Day, Group, PC1.mean, PC2.mean)%>%
  dplyr::group_by(Day, Group)%>%
  dplyr::summarise(PC1.mean = mean(PC1.mean),
                   PC2.mean = mean(PC2.mean))
...
# scale data
vegan.sig <- scale(master.sig.pca[c(4:15)])

# PerMANOVA 
permanova.sig<-adonis(vegan.sig ~ Day*Group, data = master.sig.pca, method='eu')
...
names(pca_data_sig)[4] <- "PCA1"
names(pca_data_sig)[5] <- "PCA2"
percentage <- round((scaled_pca.sig$sdev^2) / sum((scaled_pca.sig$sdev^2)) * 100, 2)
percentage <- paste( colnames(pca_data_sig[4:15]), "(", paste(as.character(percentage), "%", ")", sep="") )

#setting up data to add polygons
pca_data_sig$Day.Group <- paste(pca_data_sig$Day, pca_data_sig$Group)
find_hull <- function(pca_data_sig) pca_data_sig[chull(pca_data_sig$PCA1, pca_data_sig$PCA2), ]
hulls <- ddply(pca_data_sig, "Day.Group", find_hull)

PCA_sig<-ggplot(pca_data_sig, aes(PCA1, PCA2, color=Group)) + 
  geom_point(size = 4, alpha=0.2, aes(shape = Day))+
  scale_colour_manual(values=c("#46008B", "#8B0046", "#468B00")) +
  scale_fill_manual(values=c("#46008B", "#8B0046", "#468B00")) + 
  scale_shape_manual(values=c(15, 17, 19)) +
  ...
  ylab(percentage[2])+
  xlab(percentage[1])+
  geom_text(x=4.0, y=-4.0, label=paste("p(Day)=", z_pca.sig$`Pr(>F)`[1]), size=6, color=ifelse(z_pca.sig$`Pr(>F)`[1] < 0.05, "black", "darkgray")) + 
  geom_text(x=4.0, y=-4.5, label=paste("p(Group)=", z_pca.sig$`Pr(>F)`[2]), size=6, color=ifelse(z_pca.sig$`Pr(>F)`[2] < 0.05, "black", "darkgray")) + 
  geom_text(x=4.0, y=-5.0, label=paste("p(Day x Group)=", z_pca.sig$`Pr(>F)`[3]), size=6, color=ifelse(z_pca.sig$`Pr(>F)`[3] < 0.05, "black", "darkgray")) + 
  theme(legend.text = element_text(size=8), 
        legend.position="none",
        plot.background = element_blank(),
        legend.title = element_text(size=10), 
...
#2. add centroids 
PCAcen_sig<-PCA_sig +  geom_polygon(data = hulls, alpha = 0.2, aes(color = Group, fill = Group, lty = Day)) +
  geom_point(aes(x=PC1.mean, y=PC2.mean,color=Group, shape = Day), data=pca.centroids_sig, size=4, show.legend=FALSE) + 
  scale_linetype_manual(values = c("solid", "dashed", "dotted")) +
  scale_colour_manual(values=c("#46008B", "#8B0046", "#468B00"), breaks = c("Control","Bleached", "Mortality"), labels = c("Control", "Bleached", "Partial Mortality")) +
  scale_fill_manual(values=c("#46008B", "#8B0046", "#468B00"), breaks = c("Control","Bleached", "Mortality"), labels = c("Control", "Bleached", "Partial Mortality")) + 
  scale_shape_manual(values=c(15, 17, 19)) +
...
PCAfull_sig<-PCAcen_sig + 
  geom_segment(aes(x = Day0_PC1.mean, y = Day0_PC2.mean, xend = Day37_PC1.mean, yend = Day37_PC2.mean, colour = Group), data = segpoints, size=2, show.legend=FALSE) +
  geom_segment(aes(x = Day37_PC1.mean, y = Day37_PC2.mean, xend = Day52_PC1.mean, yend = Day52_PC2.mean, colour = Group), data = segpoints, size=2, arrow = arrow(length=unit(0.5,"cm")), show.legend=FALSE); PCAfull_sig

ggsave(filename="output/Physiology/Sig_PCA_phys.png", plot=PCAfull_sig, dpi=300, width=12, height=12, units="in")
```

```{r, echo=FALSE, out.width="100%", fig.cap="PCA sig"}
knitr::include_graphics("output/Physiology/Sig_PCA_phys.png")
```

```{r, biplotsig, echo=TRUE, warning=FALSE, message=FALSE}
#Add bi plot with loadings  

#1. make plot with dots
biplotArrows_sig <- ggplot2::autoplot(scaled_pca.sig, 
                                      data=master.sig.pca, 
                                      loadings=TRUE, color = "group", 
...
biplotArrows_sig
ggsave(filename="output/Physiology/Sig_biplot_phys.pdf", plot=biplotArrows_sig, dpi=300, width=12, height=12, units="in")
