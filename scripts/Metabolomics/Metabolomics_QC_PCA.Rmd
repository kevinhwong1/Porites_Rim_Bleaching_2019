...
peak.all3 <- peak.all2 %>% dplyr::select(Sample.ID, compound, Fragment.ID, Day, Norm.IonCount)
...
metab.df <- norm.data.all %>% dplyr::select(-Sample.ID, -Fragment.ID, -Time, -Day, -ColDay)
