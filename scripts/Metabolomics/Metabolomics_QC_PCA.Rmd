...
peak.all5 <- log((peak.all4[5:313] + 1000), 2)
...
peak.all.known5 <- log((peak.all.known4[5:185] + 1000), 2)
...
scaled_pca_all <-prcomp(norm.data.all[c(5:313)], scale=TRUE, center=TRUE)
...
# scale data
vegan_all <- scale(norm.data.all[c(5:313)])
...
scaled_pca_known <-prcomp(norm.data.known[c(5:185)], scale=TRUE, center=TRUE)
...
# scale data
vegan_known <- scale(norm.data.known[c(5:185)])
