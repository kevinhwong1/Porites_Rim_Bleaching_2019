...
TP_Coral_Box <- ggplot(master, aes(x=Day, y=Coral_Protein_mgcm2, fill = Group)) +
  ...
  theme(axis.text = element_text(size = 18, color = "black"),
        axis.title = element_text(size = 20, color = "black")) + ggtitle("Coral Total Protein")
...
TP_Sym_SA_Box <- ggplot(master, aes(x=Day, y=Symbiont_Protein_mgcm2, fill = Group)) +
  ...
  theme_bw() + theme(panel.border = element_rect(color="black", fill=NA, size=0.75), panel.grid.major = element_blank(), #Makes background theme white
                     panel.grid.minor = element_blank(), axis.line = element_blank()) +
  theme(axis.text = element_text(size = 18, color = "black"),
        axis.title = element_text(size = 20, color = "black")) + ggtitle("Symbiont Total Protein (per cm2)")
TP_Sym_SA_Box
...
TP_Sym_Cell_Box <- ggplot(master, aes(x=Day, y=Protein.mgcell, fill = Group)) +
  ...
  theme_bw() + theme(panel.border = element_rect(color="black", fill=NA, size=0.75), panel.grid.major = element_blank(), #Makes background theme white
                     panel.grid.minor = element_blank(), axis.line = element_blank()) +
  theme(axis.text = element_text(size = 18, color = "black"),
        axis.title = element_text(size = 20, color = "black")) + ggtitle("Symbiont Total Protein (per cell)")
TP_Sym_Cell_Box
...
anova(TP_Sym_cell_lmer, type="II")

capture.output(anova(TP_Sym_cell_lmer, type="II"), file = "../output/Statistics/TP_Sym_cell_lmer.csv")
...
master.sig_clean <- master.sig %>%
  dplyr::rename(Gross_Photo = Pgross_umol.cm2.hr, 
                ...
                HS_Protien = HostSymRatioProtein,
...
scaled_pca.sig <-prcomp(master.sig.pca[c(4:13)], scale=TRUE, center=TRUE)
...
biplotArrows_sig
ggsave(filename="../output/Physiology/Sig_biplot_phys.pdf", plot=biplotArrows_sig, dpi=300, width=8, height=8, units="in")
